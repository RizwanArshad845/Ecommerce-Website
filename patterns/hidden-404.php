...
<h1 class="wp-block-heading has-text-align-center" style="font-size:43px"><?php echo esc_html__('Page Not Found', 'vw-modern-ecommerce'); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__('This page could not be found. Maybe try a search?', 'vw-modern-ecommerce'); ?></p>
<!-- /wp:paragraph -->
