...
<div class="wp-block-column news-heading-inner-box" style="flex-basis:50%"><!-- wp:heading {"level":4,"className":"news-sec-heading","style":{"typography":{"textTransform":"capitalize","fontSize":"30px","fontStyle":"normal","fontWeight":"700","textAlign":"center"},"spacing":{"margin":{"top":"0","bottom":"0rem"}},"elements":{"link":{"color":{"text":"var:preset|color|ng-cream"}}}},"textColor":"ng-cream"} -->
<h4 class="wp-block-heading has-text-align-center news-sec-heading has-ng-cream-color has-text-color has-link-color" style="margin-top:0;margin-bottom:0rem;font-size:30px;font-style:normal;font-weight:700;text-transform:capitalize"><?php echo esc_html__('our latest news &amp; blogs', 'vw-modern-ecommerce'); ?></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"has-section-bg-color has-text-color has-link-color","style":{"typography":{"fontSize":"15px","lineHeight":1.4,"textAlign":"center"},"spacing":{"margin":{"top":"12px"}},"elements":{"link":{"color":{"text":"var:preset|color|ng-gold"}}}},"textColor":"ng-muted"} -->
<p class="has-text-align-center has-section-bg-color has-text-color has-link-color has-ng-muted-color" style="margin-top:12px;font-size:15px;line-height:1.4"><?php echo esc_html__('Care tips, product guides and updates from National Gold Melamine.', 'vw-modern-ecommerce'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:group {"className":"news-img","style":{"dimensions":{"minHeight":"230px"},"border":{"radius":"20px"},"spacing":{"padding":{"top":"0px","bottom":"0px","left":"0px","right":"0px"}},"color":{"background":"#2A2110"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group news-img has-background" style="border-radius:20px;background-color:#2A2110;min-height:230px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"><!-- wp:post-featured-image {"isLink":true,"height":"230px","align":"wide","style":{"border":{"radius":"20px"},"color":[]}} /--></div>
<!-- /wp:group -->

<!-- wp:post-title {"level":5,"isLink":true,"className":"news-box-title","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|20","top":"var:preset|spacing|30"}},"elements":{"link":{"color":{"text":"var:preset|color|ng-cream"}}}},"textColor":"ng-cream"} /-->

<!-- wp:post-excerpt {"className":"news-box-desc","style":{"typography":{"fontSize":"15px","lineHeight":1.4},"spacing":{"margin":{"top":"0px","bottom":"5px"}},"elements":{"link":{"color":{"text":"var:preset|color|ng-gold"}}}},"textColor":"ng-muted"} /-->

<!-- wp:group {"className":"news-meta","fontFamily":"plus-jakarta-sans","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
<div class="wp-block-group news-meta has-plus-jakarta-sans-font-family"><!-- wp:post-author-name {"style":{"typography":{"textTransform":"capitalize","lineHeight":"1.2","fontStyle":"normal","fontWeight":"600","fontSize":"15px"},"spacing":{"padding":{"left":"var:preset|spacing|50","top":"3px"}},"elements":{"link":{"color":{"text":"var:preset|color|ng-muted"}}}},"textColor":"ng-muted"} /-->
...
<!-- wp:comments -->
<div class="wp-block-comments"><!-- wp:comments-title {"showPostTitle":false,"level":6,"style":{"typography":{"fontStyle":"normal","fontWeight":"600","fontSize":"15px","textTransform":"capitalize"},"spacing":{"margin":{"top":"0px","bottom":"0px"},"padding":{"left":"var:preset|spacing|50","top":"3px"}},"elements":{"link":{"color":{"text":"var:preset|color|ng-muted"}}}},"textColor":"ng-muted"} /--></div>
<!-- /wp:comments --></div>
<!-- /wp:group -->
<!-- /wp:post-template -->

<!-- wp:query-no-results -->
<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"15px"},"elements":{"link":{"color":{"text":"var:preset|color|ng-muted"}}}},"textColor":"ng-muted"} -->
<p class="has-text-align-center has-ng-muted-color has-text-color has-link-color" style="font-size:15px"><?php echo esc_html__( 'No news posts yet — check back soon.', 'vw-modern-ecommerce' ); ?></p>
<!-- /wp:paragraph -->
